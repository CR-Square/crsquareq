...
contract Vesting{
    ...
    */
    ...
    // Withdraw all investors pending token, once the three subsequent proposal is failed
    /*
        function withdrawAllInvestorsTokens() public{
            projectRejectionStatus() if it is true then investors can withdraw all their remaining token.
        }
    */
}
