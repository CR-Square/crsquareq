...
// function withdraw for the founders
// Validators agreement on the percentage of return
// Using the time function in the smart contract
// 
...
//   updated by LEO
    ...
    function getBalanceMadeByLeo() public payable returns(uint){
    ...
    // function withdraw(address _ad) public {
    //     if(_ad == address(stakeHolders)){
    //         _ad.transfer(msg.value);
    //     }
    // } 
