...
async function setup(){
    ...
    const baseC = await ethers.getContractFactory("contracts/InvestorLogin.sol:InvestorLogin");
    const deployC = await upgrades.deployProxy(baseC);
    await deployC.deployed();
    console.log("The Investor Login contract has been deployed and this is proxy contract address",deployC.address);
}
